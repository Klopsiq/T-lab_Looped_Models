...
| E007 | Повторить final-only/auxiliary сравнение E006 на seed 71/89 | Завершён: final-only лучше на трёх из четырёх совокупных seed |
| E008 | Проверить выбранный random8…24 final-only при T=16 на новом закрытом holdout | Не выполнялся; сохранён как зарегистрированное продолжение, не требуемое для финального выбора E003/E004 |
...
Экспериментальный срез завершён на checkpoint E003 `combined_random8_16_aux`, seed 47, T=12 и его locked-test оценке E004. Результаты E005–E007 включаются как post-selection ablations и формируют направления следующей работы, но не меняют финальную модель без нового независимого test.
