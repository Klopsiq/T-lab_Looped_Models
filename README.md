...
Репликация на четырёх training seed показала, что auxiliary loss помогает только одному seed. Final-only оказался лучше на остальных трёх и выбран как более устойчивый кандидат для следующей закрытой оценки.
