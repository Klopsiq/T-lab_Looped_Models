"""E003: registered 8k-BPE comparison selected by E002."""
...
def registration(args, arm, seed, manifest):
    ...
    paths = [
        ...
        root / "research/protocols/E003_bpe_confirmation.md", root / args.data / "manifest.json",
...
def train(args, arm_name, seed, manifest, validation, validation_ids):
    ...
    elapsed = prior_seconds + time.perf_counter() - started
    result = {
        "experiment": "E003", "arm": arm_name, "seed": seed, "parameters": model.parameter_count(),
...
def main():
    ...
    parser.add_argument("--output", default="runs/E003")
    ...
    if not torch.cuda.is_available() or not args.device.startswith("cuda"):
        raise SystemExit("E003 requires CUDA")
    ...
    if manifest["context"] != args.context or manifest["tokenizer"]["vocab_size"] != 8192:
        raise ValueError("E003 corpus does not match registered context/vocabulary")
