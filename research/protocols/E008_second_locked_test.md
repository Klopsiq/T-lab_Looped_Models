...
Источник, revision, tokenizer и split rule совпадают с E004. Из test split полностью исключаются все 1,251 документа, использованные в E004. Из оставшихся документов выбираются 2,048 окон с минимальным `SHA256(document_hash:start)`. Окна имеют 513 токенов и дают 1,048,576 target-токенов. Содержимое и метрики не просматриваются до фиксации NPZ hash и evaluation-команды.
