...
| E008 | Проверить выбранный random8…24 final-only при T=16 на новом закрытом holdout | Протокол зарегистрирован; следующий шаг — зафиксировать hash holdout и выполнить evaluation |
